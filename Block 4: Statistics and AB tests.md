...
Ответ: Да - можно. При очень больших выборках (по несколько миллионов) средние по группам будут приближённо нормально распределены по ЦПТ, 
поэтому двухвыборочный t‑тест применим. Но предпочтительней использовать T-критерий Уэлча, так как он не требует равенства дисперсий.
